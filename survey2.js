                    ...
                    "elements": [
                        {
                            ...
                            "html": `
                            <article class='intro'>
                                <h1 class='intro__heading intro__heading--income title'>Questionário</h1>
                                <div class='intro__body wysiwyg'>
                                    <p>In this section, you will be asked about your current employment and any other way you and your partner
                                        currently receive income.</p>
                                    <p>It will be handy to have the following in front of you:</p>
                                    <ul>
                                        <li> Payslip (for employment details) </li>
                                        <li>
                                            <p>A current Centrelink Schedule for any account based pension from super, annuities, or other income
                                                stream products that you own</p>
                                            <p> If you don't have a current one you can get these schedules by contacting your income stream
                                                provider </p>
                                        </li>
                                        <li> Latest statement from any payments (from Centrelink or other authority) </li>
                                    </ul>
                                </div>
                            </article>`
...
$("#surveyElement2").Survey({model: survey});